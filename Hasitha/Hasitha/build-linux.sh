...
if [ ! -e disk_images/leo_OS.flp ]
then
	echo ">>> Creating new leo_OS floppy image..."
	mkdosfs -C disk_images/leo_OS.flp 1440 || exit
fi
...
mkdir tmp-loop && mount -o loop -t vfat disk_images/leo_OS.flp tmp-loop && cp source/kernel.bin tmp-loop/
