;LEO Os --- The LEO Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE LEO_OS_VER '1.0.0'	 ;OS version number
	%DEFINE LEO_OS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as LEO_OS and its programs
...
option_screen:
	...
	os_init_msg		db '*************************Welcome to Leo OS****************************', 0
	os_version_msg		db 'Version ', LEO_OS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', LEO_OS_VER, 0

	dialog_string_1		db 'Welcome to Leo Operating System', 0
	dialog_string_2		db 'To see Hardware Informations Press Enter', 0
	dialog_string_3		db 'Exit', 0
...
os_draw_background1:
	...
	mov cx, 10101111b		; Colour: light green text on white
